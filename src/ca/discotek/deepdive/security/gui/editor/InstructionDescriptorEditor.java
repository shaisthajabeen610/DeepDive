...
public class InstructionDescriptorEditor extends JPanel implements InstructionDescriptionEditor {

    OpcodeEditor opcodeField;
    EnabledButtonWrapper opcodeWrapper;
    
    public InstructionDescriptorEditor() {
        buildGui();
    }
    ...
    void buildGui() {
        ...
        opcodeField = new OpcodeEditor(OpcodeEditor.InstructionOpcodes);
