...
public class PreferencesDialog extends JDialog {
	...
	public PreferencesDialog(GrepGui grepGui) {
		super(grepGui, "Preferences", true);
		this.grepGui = grepGui;
		buildGui();
	}
	...
	void buildGui() {
		...
		panel.add(new JLabel("History Size"), labelGbc);
		
		SpinnerModel model = new SpinnerNumberModel(grepGui.getHistorySize(), 0, Integer.MAX_VALUE, 1);
		historySizeField = new JSpinner(model);
		panel.add(historySizeField, fieldGbc);
	...
	public int getHistorySize() {
		return (Integer) historySizeField.getValue();
	}
